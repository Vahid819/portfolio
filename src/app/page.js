...
function page() {
  ...
  <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center z-0 text-white">
    <div className="flex flex-col lg:flex-row justify-around gap-4 lg:gap-36 h-auto lg:h-40 items-center px-4">
      ...
      <img
        ...
        className="w-1/2 lg:w-1/4 h-auto rounded-lg shadow-lg transition-all duration-700 hover:scale-110 hover:rotate-2 z-10 relative top-14"
      />

      <div className="absolute inset-0 flex md:flex-wrap sm:flex-wrap flex-wrap md:gap-10 p-4 -z-10">
        <img
          src="/Express-js.png"
          alt="Express.js"
  ...
  viewBox="0 0 394 80"
  className={`w-full md:max-w-[256px] max-w-[156px] h-[150px] object-contain rounded-xl shadow-md hover:scale-125 hover:rotate-12 hover:shadow-xl transition-all duration-500 ease-in-out hover:bg-gray-400/30 backdrop-blur-sm ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
  fill="none"
>
  <path 
