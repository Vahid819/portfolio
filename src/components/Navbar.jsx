    ...
    <div className="w-[90%] h-16 absolute top-6 left-1/2 transform -translate-x-1/2 rounded-xl border border-white/20 bg-white/10 shadow[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-md backdrop-filter flex items-center px-6 justify-around">
      ...
      <NavigationMenu className="w-auto">
        <NavigationMenuList className="space-x-8">
          <NavigationMenuItem className="w-20 text-center hover:rounded-xl border hover:border-white/20 hover:bg-white/10 hover:shadow[0_8px_32px_0_rgba(31,38,135,0.37)] hover:backdrop-blur-md hover:backdrop-filter rounded-md px-3 py-1 transition-all">
            <Link href="/">Home</Link>
          </NavigationMenuItem>
          <NavigationMenuItem className="w-20 text-center hover:rounded-xl border hover:border-white/20 hover:bg-white/10 hover:shadow[0_8px_32px_0_rgba(31,38,135,0.37)] hover:backdrop-blur-md hover:backdrop-filter rounded-md px-3 py-1 transition-all">
